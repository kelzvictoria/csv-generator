...
(function () {
  ...
  formatNumber = function () {
    ...
    value = num[0];
    digits = 0 || num[1];
    return typeof value == 'number' ? addCommas(value.toFixed(digits)) : value;
  };
  ...
  GaugePointer = (function (superClass) {
    ...
    function GaugePointer(gauge1) {
      ...
      if (!this.gauge.canvas) {
        throw new Error("The canvas isn't defined.");
      }
  ...
  Gauge = (function (superClass) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        if (value.label !== void 0) {
          if (
            ...
            this.ctx.fillText(
              typeof staticLabels.format == 'function' ? staticLabels.format(value.label) : formatNumber(value.label, staticLabels.fractionDigits),
              0,
          ...
          if (
            ...
            this.ctx.rotate(rotationAngle);
            this.ctx.fillText(
              typeof staticLabels.format == 'function' ? staticLabels.format(value) : formatNumber(value, staticLabels.fractionDigits),
              0,
              -radius - this.lineWidth / 2
            );
            this.ctx.rotate(-rotationAngle);
    ...
    Gauge.prototype.renderTicks = function (ticksOptions, w, h, radius) {
      ...
      //    divColor = ticksOptions.divColor || "#E74C3C";
